...
+'                  <a class="dropdown-item" href="inserirNovoFilme.html">Inserir novo</a>'
+'                  <a class="dropdown-item" href="editarFilme.html">Editar existente</a>'
+'                  <a class="dropdown-item" href="excluirFilme.html">Excluir existente</a>'
+'                </div>'
+'              </li>'
+'            <li class="nav-item dropdown">'
...
+'                    <a class="dropdown-item" href="inserirAtor.html">Inserir novo</a>'
...
+'                    <a class="dropdown-item" href="inserirDiretor.html">Inserir novo</a>'
...
+'                    <a class="dropdown-item" href="inserirProdutor.html">Inserir novo</a>'
...
+'                    <a class="dropdown-item" href="inserirEstudio.html">Inserir novo</a>'
+'                    <a class="dropdown-item" href="editarEstudio.html">Editar existente</a>'
...
+'                  </a>'
+'                  <div class="dropdown-menu" aria-labelledby="navbarStudiosDropdown">'
+'                    <a class="dropdown-item" href="inserirUsuario.html">Inserir novo</a>'
+'                    <a class="dropdown-item" href="editarUsuario.html">Editar existente</a>'
...
+'        <h3>Bem vindo ao painel de controle do sitio Hollywood Database</h3>'
+'        <article>'
